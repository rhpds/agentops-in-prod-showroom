...
[source,logql]
----
{ log_type="application", kubernetes_namespace_name="wksp-{user}" }
----
+
...
[source,logql]
----
{ log_type="application", kubernetes_namespace_name="wksp-{user}", kubernetes_container_name="ui" } |= "/api/"
----
+
...
[source,logql]
----
{ log_type="application", kubernetes_namespace_name="wksp-{user}", kubernetes_container_name="ui" } |= "/api/chat"
----
+
...
[source,logql]
----
{ log_type="application", kubernetes_namespace_name="wksp-{user}", kubernetes_container_name="api" }
----
...
* Logs provide the detail that metrics aggregate away -- essential for debugging ephemeral containers
