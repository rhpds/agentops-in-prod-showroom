...
* **Total LLM Tokens (1h)**: tokens consumed in the last hour. This is your cost proxy, in the screenshot, 18.5K tokens. This panel requires more than 1 hour of collected data to display meaningful values.
