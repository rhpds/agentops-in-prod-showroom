...
每个智能体拥有独立端点、工具与业务职责，智能体之间**不会直接相互调用**——相反，它们是服务于不同用户角色的独立工作流程。Each agent has its own endpoint, tools, and responsibilities. They **don't call each other** directly—instead, they're isolated workflows serving different user roles:
