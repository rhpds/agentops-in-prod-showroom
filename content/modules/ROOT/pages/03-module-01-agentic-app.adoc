...
. Once logged in, verify the project selector (top-left) shows `wksp-{user}`. Navigate to **Workloads > Pods** to see the mortgage-ai components running in your namespace:
+
...
----
+
You can also find this route in the OpenShift Console you explored earlier. Navigate to **Networking > Routes** in the `wksp-{user}` project and filter by Name `mortgage-ai-ui`:
+
